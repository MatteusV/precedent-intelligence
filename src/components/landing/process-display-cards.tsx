...
const stackClassName =
  "before:absolute before:top-0 before:left-0 before:h-[100%] before:w-[100%] before:rounded-xl before:bg-background/50 before:bg-blend-overlay before:outline-1 before:outline-border before:transition-opacity before:duration-700 before:content-[''] hover:before:opacity-0";

const processCards = [
  {
    icon: <FileText className="size-4 text-amber-200" />,
    title: "Acórdão",
  ...
  {
    icon: <Scale className="size-4 text-amber-200" />,
    title: "Dossiê citado",
  ...
  {
    icon: <ScrollText className="size-4 text-amber-200" />,
